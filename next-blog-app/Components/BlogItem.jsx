...
const BlogItem = () =>{
    return(
        <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-7px_7px_0px_#000000]'>
            ...
            <div className='p-5'>
                <h5 className='mb-2 text-lg font-medium tracking-tight text-grey-900'>{blog_data[0].title}</h5>
                <p className='mb-3 text-sm tracking-tight text-grey-700'>{blog_data[0].description}</p>
